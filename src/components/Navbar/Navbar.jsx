...
const Navbar = () => {
  ...
  // const handleFeatureMenuOpen = (event) => {
  //   setAnchorEl(event)
  // }
  ...
  const renderMenu = (
    ...
    <Popper className={classes.menu} open={isMenuOpen} anchorEl={anchorEl} role={undefined} transition disablePortal>
      ...
      >
        <Paper>
          <ClickAwayListener onClickAway={handleMenuClose}>
            <MenuList autoFocusItem={openMenu} id="menu-list-grow" disablePadding>
              <MenuItem onClick={handleMenuClose}>Profile</MenuItem>
              <MenuItem onClick={handleMenuClose}>Hyloooooooooooooooooooo</MenuItem>
    ...
    >
      ...
      <MenuItem>
        <IconButton aria-label="show 11 new notifications" color="inherit">
          <Badge badgeContent={11} color="danger">
            <NotificationsIcon />
          </Badge>
        </IconButton>
        <p>Notifications</p>
  ...
  return (
    <div className={classes.grow}>
      <AppBar position="fixed">
        <Toolbar>
          <Box className={classes.navigationButtons} onMouseLeave={handleMenuClose}>
            <Button
...
//   const renderMenu = (
//     <Menu
//       MenuProps={{ disableScrollLocak: true, disablePadding: true }}
//       anchorEl={anchorEl}
//       anchorOrigin={{ vertical: "top", horizontal: "right" }}
//       id={menuId}
//       keepMounted
